...
const canonicalBindings = new Map([
  ['SNIP-02', 'src/components/languageContextState.js'],
  ['SNIP-03', 'src/components/useLanguage.js'],
  ['SNIP-04', 'src/components/LanguageContext.jsx'],
  ['SNIP-05', 'src/components/LanguageChange.jsx'],
]);
const excerptBindings = new Map([
  ['SNIP-06', 'src/App.jsx'],
  ['SNIP-07', 'src/components/FeedbackForm.jsx'],
  ['SNIP-09', 'src/App.semantic-values.test.jsx'],
]);
const commandBindings = new Map([
  ['SNIP-01', 'npm ci\nnpm run dev'],
  ['SNIP-08', 'npm run check'],
]);
...
const exampleAllowlist = [
  ...
  'src/App.css',
  'src/App.jsx',
  'src/App.semantic-values.test.jsx',
  'src/App.test.jsx',
  'src/components/FeedbackForm.jsx',
  'src/components/Header.jsx',
  'src/components/LanguageChange.jsx',
  'src/components/LanguageContext.jsx',
  'src/components/LanguageContext.test.jsx',
  'src/components/languageContextState.js',
  'src/components/useLanguage.js',
  'src/components/useLanguage.test.jsx',
...
const expectedHistorySubjects = [
  ...
  'feat: define the guarded language context',
  'feat: add the cancellable translation source',
  'feat: connect the translated feedback workflow',
];
...
const checkout = await mkdtemp(resolve(tmpdir(), 'language-context-history-'));
try {
  await run('git', [
    'clone',
    '--quiet',
